...
public class TestDriver
{
            ...
            throws Exception
    {
        ...
        try (Connection connection = createConnection("blackhole", "blackhole");
            ...
            try (ResultSet rs = connection.getMetaData().getColumns("blackhole", "blackhole", "test_get_columns_table", null)) {
                ...
                assertColumnSpec(rs, Types.FLOAT, 24L, 2L, null, null, FloatType.FLOAT);
                assertColumnSpec(rs, Types.DOUBLE, 53L, 2L, null, null, DoubleType.DOUBLE);
                assertColumnSpec(rs, Types.LONGNVARCHAR, 1234L, null, null, 1234L, VarcharType.createVarcharType(1234));
                assertColumnSpec(rs, Types.LONGNVARCHAR, (long) Integer.MAX_VALUE, null, null, (long) Integer.MAX_VALUE, VarcharType.createUnboundedVarcharType());
                ...
                assertColumnSpec(rs, Types.DATE, 15L, null, null, null, DateType.DATE);
                assertColumnSpec(rs, Types.DECIMAL, 8L, 10L, 2L, null, DecimalType.createDecimalType(8, 2));
                assertColumnSpec(rs, Types.DECIMAL, 38L, 10L, 0L, null, DecimalType.createDecimalType(38, 0));
            ...
            throws SQLException
    {
        ...
        assertEquals(rs.getObject("NUM_PREC_RADIX"), numPrecRadix, "NUM_PREC_RADIX of " + message);
